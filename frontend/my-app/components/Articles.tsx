...
export default async function Articles() {
  ...
  return (
    <section className="py-24">
      <div className="mb-12 flex flex-wrap items-end justify-between gap-6"><div><p className="neo-eyebrow">Dernières publications</p><h2 className="mt-3 font-heading text-4xl font-black md:text-5xl">Notes &amp; articles</h2><p className="mt-4 max-w-xl text-lg leading-8 text-on-surface/70">Du concret sur les architectures, les outils et le métier de développeur.</p></div><Link href="/articles" className="border-b-2 border-tertiary-fixed font-bold uppercase tracking-wide">Voir toutes les publications →</Link></div>
