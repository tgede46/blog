...
export default async function ArticlesPage({ searchParams }: Props) {
  ...
  return (
    <div className="graphic-grid min-h-screen bg-surface text-on-surface"><Nav /><main id="contenu" className="mx-auto max-w-6xl px-5 py-16">
      <p className="neo-eyebrow">Archives</p><h1 className="mt-3 font-heading text-5xl font-black sm:text-6xl">Articles</h1><p className="mt-5 text-lg text-[#687184]">Guides, retours d’expérience et réflexions sur le logiciel.</p>
